...
def getMakerData(maker):
    ...
    print(f"[-] Dumping data for {maker}..")
...
makers = []
with open("makers.txt", 'r') as file:
    makers.extend([line.strip() for line in file.readlines()])
...
with open('maker_data.json', 'w') as outfile:
    ...
    print(f"[✅] Dumped profit data for {len(results)} wallet(s)..")
